        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('dashboard.transaction.index') }}" :active="request()->routeIs('Product')">
                        {{ __('Transactions') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('dashboard.user.index') }}" :active="request()->routeIs('Product')">
                        {{ __('Users') }}
                    </x-nav-link>
                </div>
            </div>
